...
const normalizePosition = (position = {}) => ({
  ...
  daily_profit: safeNumber(position.daily_profit ?? position.yesterday_profit ?? position.totalYesterdayProfit),
  yesterday_profit: safeNumber(position.yesterday_profit ?? position.daily_profit ?? position.totalYesterdayProfit),
  totalYesterdayProfit: safeNumber(position.totalYesterdayProfit ?? position.yesterday_profit ?? position.daily_profit),
