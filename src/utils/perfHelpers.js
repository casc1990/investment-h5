...
export const normalizeSnapshotPosition = (item = {}) => ({
  ...
  daily_profit: safeNumber(item.daily_profit ?? item.yesterday_profit ?? item.totalYesterdayProfit),
  yesterday_profit: safeNumber(item.yesterday_profit ?? item.daily_profit ?? item.totalYesterdayProfit),
  totalYesterdayProfit: safeNumber(item.totalYesterdayProfit ?? item.yesterday_profit ?? item.daily_profit),
